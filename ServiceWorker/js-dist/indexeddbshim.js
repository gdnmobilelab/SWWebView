...
(function () {
  ...
  */
  ...
  var exportObj = ('object' !== 'undefined' && module.exports) ? exports : window;
...
function escapeDatabaseNameForSQLAndFiles (db) {
    ...
    if (CFG.escapeNFDForDatabaseNames !== false) {
        ...
        db = db.replace(new RegExp(regex, 'g'), function (expandable) {
...
let test;
let useNativeDOMException = false;
...
const {EventTargetFactory: EventTargetFactory$1} = EventTarget;
let uniqueID = 0;
const listeners$1 = ['onabort', 'oncomplete', 'onerror'];
const readonlyProperties$4 = ['objectStoreNames', 'mode', 'db', 'error'];
...
IDBTransaction.prototype = EventTargetFactory$1.createInstance({defaultSync: true, extraProperties: ['complete']}); // Ensure EventTarget preserves our properties
...
const {EventTargetFactory: EventTargetFactory$2} = EventTarget;
const listeners$2 = ['onabort', 'onclose', 'onerror', 'onversionchange'];
const readonlyProperties$5 = ['name', 'version', 'objectStoreNames'];
...
IDBDatabase.prototype = EventTargetFactory$2.createInstance();
...
const readonlyProperties$3 = ['lower', 'upper', 'lowerOpen', 'upperOpen'];
...
var typeson$1 = Typeson;

var userObjects = [
    function (x, stateObj) { return typeson$1.isUserObject(x); },
...
var _undefined$2 = {
    undefined: [
        ...
        function (s) { return new typeson$1.Undefined();} // Will add `undefined` (returning `undefined` would instead avoid explicitly setting)
    ]
};
...
var primitiveObjects = {
    ...
    StringObject: [
        function (x) { return typeson$1.toStringTag(x) === 'String' && typeof x === 'object'; },
    ...
    BooleanObject: [
        function (x) { return typeson$1.toStringTag(x) === 'Boolean' && typeof x === 'object'; },
    ...
    NumberObject: [
        function (x) { return typeson$1.toStringTag(x) === 'Number' && typeof x === 'object'; },
...
var NegativeInfinity = {
	NegativeInfinity: NegativeInfinity_1
};
...
var Date_1 = [
    function (x) { return typeson$1.toStringTag(x) === 'Date'; },
    function (date) {
...
var RegExp_1 = [
    function (x) { return typeson$1.toStringTag(x) === 'RegExp'; },
    function (rexp) {
        return {
            source: rexp.source,
...
var arrayFromIterator = Array.from || function (iterator) {
   var res = [];
...
var Map_1 = [
    function (x) { return typeson$1.toStringTag(x) === 'Map'; },
    function (map) { return arrayFromIterator(map.entries()); },
...
var Set_1 = [
    function (x) { return typeson$1.toStringTag(x) === 'Set'; },
    function (set) { return arrayFromIterator(set.values()); },
...
var ArrayBuffer$1 = [
    function test (x) { return typeson$1.toStringTag(x) === 'ArrayBuffer';},
    function encapsulate (b) { return base64Arraybuffer.encode(b); },
    function revive (b64) { return base64Arraybuffer.decode(b64); }
];
...
var _global = typeof self === 'undefined' ? commonjsGlobal : self;
...
[
    ...
    if (TypedArray) exports[typeName] = [
        function test (x) { return typeson$1.toStringTag(x) === typeName; },
        function encapsulate (a) { return base64Arraybuffer.encode (a.buffer, a.byteOffset, a.byteLength); },
        function revive (b64) { return new TypedArray (base64Arraybuffer.decode(b64)); }
    ];
});
});

var DataView_1 = [
    function (x) { return typeson$1.toStringTag(x) === 'DataView'; },
    function (dw) { return { buffer: base64Arraybuffer.encode(dw.buffer), byteOffset: dw.byteOffset, byteLength: dw.byteLength }; },
    function (obj) { return new DataView(base64Arraybuffer.decode(obj.buffer), obj.byteOffset, obj.byteLength); }
];
...
var intlTypes = createCommonjsModule(function (module, exports) {
exports["Intl.Collator"] = [
    function (x) { return typeson$1.hasConstructorOf(x, Intl.Collator); },
...
exports["Intl.DateTimeFormat"] = [
    function (x) { return typeson$1.hasConstructorOf(x, Intl.DateTimeFormat); },
...
exports["Intl.NumberFormat"] = [
    function (x) { return typeson$1.hasConstructorOf(x, Intl.NumberFormat); },
...
var ImageData_1 = [
    function (x) { return typeson$1.toStringTag(x) === 'ImageData'; },
    function (d) {
        return {
...
var File_1 = {
    test: function (x) { return typeson$1.toStringTag(x) === 'File'; },
...
var File$1 = file.File;
var FileList = {
    test: function (x) { return typeson$1.toStringTag(x) === 'FileList'; },
    replace: function (fl) {
        var arr = [];
...
var Blob_1 = {
    test: function (x) { return typeson$1.toStringTag(x) === 'Blob'; },
...
var structuredCloningThrowing = structuredCloning.concat({checkDataCloneException: [function (val) {
...
const typeson = new typeson$1().register(structuredCloningThrowing);
...
function encode$1 (obj, cb) {
    ...
    try {
        ...
        if (typeson$1.hasConstructorOf(err, ReferenceError) ||
...
var Sca = Object.freeze({
	encode: encode$1,
	decode: decode$1,
	clone: clone
});

const readonlyProperties$6 = ['objectStore', 'keyPath', 'multiEntry', 'unique'];
...
IDBIndex.__createInstance = function (store, indexProperties) {
    function IDBIndex () {
        ...
        defineReadonlyProperties(me, readonlyProperties$6);
...
IDBIndex.prototype.count = function (/* query */) {
    ...
    if (instanceOf(query, IDBKeyRange)) { // Todo: Do we need this block?
        ...
        if (data.rows.length > 0) {
            ...
            for (let i = 0; i < data.rows.length; i++) {
                ...
                for (let j = 0; j < matches.length; j++) {
                    ...
                    clone$$1[me.__keyColumnName] = rowItem[me.__keyColumnName];
                    clone$$1[me.__valueColumnName] = rowItem[me.__valueColumnName];
                    rows.push(clone$$1);
                }
            }
...
function setGlobalVars$1 (idb, initialConfig) {
    if (initialConfig) {
